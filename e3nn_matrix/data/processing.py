...
class MatrixDataProcessor:
    ...
    def labels_to_csr(self, data: dict[str, np.ndarray], coords_cartesian: bool = False):
...
class BasisMatrixData:
    ...
    def to_csr(self) -> sisl.SparseOrbital:
        ...
        return data_processor.labels_to_csr(arrays)
