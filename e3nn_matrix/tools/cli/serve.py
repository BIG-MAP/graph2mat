...
def main(
    ...
    local: Annotated[bool, typer.Option(help="If True, the server allows the user to ask for changes in the local file system.")] = False,
):
    import uvicorn
    ...
    # Then build the app
    fastapi_app = create_server_app_from_filesystem(ckpt_files_dict, cpu=cpu, local=local)
